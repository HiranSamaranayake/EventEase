    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
        ...
        <div className={`hidden md:flex items-center gap-8 font-semibold text-sm ${isDark ? "text-slate-200" : "text-gray-700"}`}>
          ...
          <Link to="/customer-support" className="hover:text-purple-500 transition duration-300">
            Help & Support
          </Link>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          {!user ? (
            ...
            <div className="flex items-center gap-2">
              <Link
                to={getDashboardPath()}
                className="text-xs font-bold px-3 py-1.5 rounded-xl bg-purple-500/20 text-purple-300 border border-purple-500/30 hover:bg-purple-500/30 transition"
              >
              ...
              <button
                ...
                className="px-3 py-1.5 text-xs font-bold text-rose-400 bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/30 rounded-xl transition"
              >
                Logout
              </button>
